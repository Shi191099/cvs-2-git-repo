...
def setup_working_copy(wc_dir, value_len):
  ...
  svntest.main.file_append(author_rev_exp_path, "$Author$\n$Rev: 0 $")
  ...
  svntest.main.file_append(header_exp_path, "$Header$")
  ...
  svntest.main.file_append(id_exp_with_dollar_path,
                   "$Id$_sign 1 2006-06-10 11:10:00Z jrandom $")
