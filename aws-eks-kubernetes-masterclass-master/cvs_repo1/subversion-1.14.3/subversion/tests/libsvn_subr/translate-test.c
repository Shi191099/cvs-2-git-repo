...
static const char *lines[] =
  {
    ...
    /* The idea here is that, were it not broken across two lines,
       "$Author$" would be a valid if odd, keyword. */
    ...
    "Line 24: keyword in a keyword: $Author$Date: 2024/03/17 17:01:34 $ $",
    ...
    "Line 74: Valid $Author$dom $, started expanded.",
    ...
    "Line 80: Valid $Author$aaaaaaaaaaaaaaa"
    ...
    "Line 81: Valid $Author$aaaaaaaaaaaaaaaaaaaaaaaaaaa"
    ...
    "Line 82: Valid $Author$$aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    ...
    "Line 83: Invalid $Author$$aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    "aaaaaaaaaaaaaaaaaaaaaaaaaa$$$$aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa$$aaaaaaaaaaaaaaaaaaaaaaaaaaa"
    "aaaaaaaaaaaaaa$$aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa$$$ $, started "
    "expanded.",
    "Line 84: Invalid $Author$$aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    "aaaaaaaaaaaaaaaaaaaaaaaaaa$$$$aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa$$aaaaaaaaaaaaaaaaaaaaaaaaaaa"
      ...
      if (expand)
        {
          ...
          expect[9 - 1] =
            apr_pstrcat(pool, "Line 9: ",
                        "Valid $Author$, started unexpanded.",
                        SVN_VA_NULL);
          expect[37 - 1] =
          ...
          expect[38 - 1] =
            apr_pstrcat(pool, "Line 38: ",
                        "Valid $Author$, started expanded.",
                        SVN_VA_NULL);
          expect[46 - 1] =
            apr_pstrcat(pool, "Line 46: ",
                        "Empty $Author$, started expanded.",
                        SVN_VA_NULL);
          expect[71 - 1] =
            apr_pstrcat(pool, ".$veR$Author$", SVN_VA_NULL);
      ...
      if (expand)
        {
          ...
          expect[49 - 1] =
            apr_pstrcat(pool, "Line 49: ",
                        ...
                        SVN_VA_NULL);
          expect[70 - 1] =
            apr_pstrcat(pool, "$Author$Rev$.", SVN_VA_NULL);
        }
  ...
  if (date && author)
    {
      if (expand)
      ...
      else  /* unexpand */
        {
          expect[24 - 1] =
            apr_pstrcat(pool, "Line 24: ",
                        "keyword in a keyword: $Author$Date: 2024/03/17 17:01:34 $ $",
                        SVN_VA_NULL);
        }
    }
  else if (date && (! author))
